...
// ROS2 YOLO 叠框节点。
// 节点订阅 /camera/image_mjpeg，调用 RKNN 推理器，缓存最新检测结果，
...
#include "yolo_web_cpp/yolo11_rknn_detector.hpp"

namespace yolo_web_cpp
{

class YoloOverlayNode : public rclcpp::Node
{
public:
  YoloOverlayNode();
  ~YoloOverlayNode() override;
