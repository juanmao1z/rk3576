...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package="dm_h3510_ros_cpp",
            executable="dm_h3510_ros_cpp_node",
            name="dm_h3510_ros_cpp_node",
            output="screen",
            parameters=[
                default_config,
                {
