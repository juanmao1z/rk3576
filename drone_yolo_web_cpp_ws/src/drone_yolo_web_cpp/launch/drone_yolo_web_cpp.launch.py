...
launch 参数只描述运行期可调配置，默认值保持 drone 专用路径：
模型使用开发板 /home/lckfb/workspace 下的训练后 RKNN，标签默认 drone。
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'model_path',
            default_value='/home/lckfb/workspace/trained_yolo11n_best_rk3576_i8.rknn'),
