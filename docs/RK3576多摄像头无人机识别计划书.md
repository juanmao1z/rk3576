...
```text
D:\Desktop\rk3576\workspace\drone_yolo_web_cpp_ws
```

摄像头主链路位于：

```text
D:\Desktop\rk3576\workspace\camera_web_cpp_ws
```
...
```powershell
adb forward --list
powershell -ExecutionPolicy Bypass -File D:\Desktop\rk3576\workspace\drone_yolo_web_cpp_ws\scripts\windows\start_multi_drone_yolo_cpp_all.ps1
powershell -ExecutionPolicy Bypass -File D:\Desktop\rk3576\workspace\drone_yolo_web_cpp_ws\scripts\windows\stop_multi_drone_yolo_cpp_all.ps1
```
