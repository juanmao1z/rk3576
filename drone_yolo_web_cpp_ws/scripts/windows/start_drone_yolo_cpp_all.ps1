...
# RKNN_MODEL 和 DETECTION_LABELS 通过环境变量传给板端无人机 YOLO 启动脚本。
adb shell "bash -lc ': >/tmp/start_drone_yolo_cpp_all.log; RKNN_MODEL=$Model DETECTION_LABELS=$Labels nohup $remoteScript $cameraArgs >/tmp/start_drone_yolo_cpp_all.log 2>&1 & echo STARTED'"
